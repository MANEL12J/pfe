  ...
  Future<void> _submit() async {
    if (_formKey.currentState!.validate()) {
      ...
      if(_email=="chefdepartement@gmail.com" && _password== "chef2024"){
        ...
        Navigator.push(context, MaterialPageRoute(builder: (context) => navigationadjoint(idnavigateur: "adjoint")),);
      }
        ...
        body: Stack(
          children: [
            ...
            Positioned(
              ...
              left: 0,
              right: 0,
              bottom: MediaQuery.of(context).size.height * 0.87,  // Ajustez cette valeur selon vos besoins
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelStyle: TextStyle(
                                  fontSize: 12, // Set the font size smaller as needed
                                  // Optional: You can also change the color
                                ),
                                prefixIcon: Icon(Icons.email,
                                  size : 15,
                                  color: _isEmailFocused ? Colors.purple : Colors.grey,),
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                prefixIcon: Icon(Icons.lock,
                                  size : 15,
                                  color: _isPasswordFocused ? Colors.purple : Colors.grey,),
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(0),
                                ),
                                focusedBorder: OutlineInputBorder(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    child:
                                    Expanded(
                                      child: Text('CONEXSSION ', style: TextStyle(
                                        color: Colors.white,
                                      ),),
                                    ),
